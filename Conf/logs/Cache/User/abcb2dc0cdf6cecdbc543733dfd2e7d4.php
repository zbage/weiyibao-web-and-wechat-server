            ...
            <table class="userinfoArea" border="0" cellspacing="0" cellpadding="0" width="100%">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><input type="text" required="" name="weixin" value="" class="px" tabindex="1" size="25">　比如：AI9 </td>
                </tr>
                 ...
                 <tr style="display:none">
                  ...
                  <td><input type="text" name="token" value="<?php echo ($tokenvalue); ?>" class="px" tabindex="1" size="40">(填写你的公众号)例：AI9weixin,请勿填写文,或者其它特殊字符，此处token和腾讯平台必须一致!</td>
                </tr>
...
<div class="foot">
<div class="foot_page" >
<a href="<?php echo C('site_url');?>">【AI9】 ,微信公众平台营销</a><br/>
帮助您快速搭建属于自己的营销平台,构建自己的客户群体。<br/>
大转盘、刮刮卡，会员卡,优惠卷,订餐,订房等营销模块,客户易用,易懂,易营销（【AI9】 易服务理念）。
</div>
<div id="copyright" style="color:white">
	<?php echo C('site_name');?>(c)2013 cms版权所有<br/>
	技术支持：<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=860008559&site=qq&menu=yes"><img height="20" border="0" src="http://wpa.qq.com/pa?p=2:860008559:51" alt="联系我吧" title="联系我吧"/></a>
	售前咨询：<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=860008559&site=qq&menu=yes"><img height="20" src="http://wpa.qq.com/pa?p=2:860008559:51" alt="联系我吧" title="联系我吧"/></a>
	...
	<div class="onlinebox-conbox" id="onlinebox-conbox" style="position: absolute; left: -94px; width: 118px; display:none;">
		...
		<div class="onlinebox-center">
			<div class="onlinebox-center-box">
				<dl>
					<dt>使用帮助</dt>
						<dd><a href="tencent://message/?uin=860008559&amp;Site=&amp;Menu=yes" title="QQ咨询服务">
						<img border="0" src="http://wpa.qq.com/pa?p=2:860008559:42"></a>
						</dd>
					</dl>
				<div class="clear"></div>
				<dl>
					<dt>技术询问</dt>
					<dd>
						<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=860008559&site=qq&menu=yes">
							<img border="0" src="http://wpa.qq.com/pa?p=2:860008559:42" alt="咨询服务" title="咨询服务"/>
						</a>
					</dd>
				</dl>
				<div class="clear"></div>
				<dl><dt>合作加盟</dt>
				<dd>
					<a href="tencent://message/?uin=860008559&amp;Site=&amp;Menu=yes" title="QQ合作加盟">
						<img border="0" src="http://wpa.qq.com/pa?p=2:860008559:47">
					</a>
				</dd>
				</dl>
				<div class="clear"></div>
