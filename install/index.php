...
'license'=>'<div class="license"><h1>系统安装协议</h1>
			...
			<strong>二、协议许可的权利 </strong>
				...
				<p>2、您可以在协议规定的约束和限制范围内修改AI9微信公共平台源代码或界面风格以适应您的网站要求。 </p>
			...
			<strong>三、协议规定的约束和限制 </strong>
				...
				<p>3、不管你的网站是否整体使用AI9微信公共平台 ，还是部份栏目使用AI9微信公共平台，在你使用了AI9微信公共平台 的网站主页上必须加上AI9微信公共平台   官方网址(<a href="http://www.ai9.me" target="_blank">www.ai9.me</a>)的链接。</p>
				<p>4、未经官方许可，禁止在AI9微信公共平台的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。</p>
			...
			<strong>四、有限担保和免责声明 </strong>
				...
				<p>3、电子文本形式的授权协议如同双方书面签署的协议一样，具有完全的和等同的法律效力。您一旦开始确认本协议并安装AI9微信公共平台，即被视为完全理解并接受本协议的各项条款，在享有上述条款授予的权力的同时，受到相关的约束和限制。协议许可范围以外的行为，将直接违反本授权协议并构成侵权，我们有权随时终止授权，责令停止损害，并保留追究相关责任的权力。</p>
				<p>4、如果本软件带有其它软件的整合API示范例子包，这些文件版权不属于本软件官方，并且这些文件是没经过授权发布的，请参考相关软件的使用许可合法的使用。</p>
				<p><b>版本最新更新：</b> 2013年11月1日</p>
                <p align=right>BY:AI9微信公共平台</p>
</div>',
'agreement_yes' => '我同意，继续安装',
'agreement_no' => '我不同意',
'title_install' => ' AI9微信公共平台 V'.SOFT_VERSION.' 安装程序',
...
'install_succ_remark'=>'<p class=\'nest\'>系统安装完成：</p>
		<p class=\'nes\'>1.系统后台地址：<a href=\'http://'.$_SERVER['HTTP_HOST'].trim(str_replace(strstr($_SERVER['SCRIPT_NAME'], '/install'),"",$_SERVER['SCRIPT_NAME'])).'/ai9.php\' target=\'_blank\'>http://'.$_SERVER['HTTP_HOST'].trim(str_replace(strstr($_SERVER['SCRIPT_NAME'], '/install'),"",$_SERVER['SCRIPT_NAME'])).'/ai9.php</a></p>
...
<meta content="AI9微信公共平台" name="Copyright" />
...
?>
			<div class="footer">
			    <p>Powered by AI9微信公共平台© v1.0 2012-2013</p>
				<p>版权所有</p>
			</div>
		</div>
		</div>
...
function runquery($sql) {
	...
	$sql = str_replace("\r", "\n", str_replace('ai9me_', $tablepre, $sql));
	$ret = array();
	$num = 0;
	foreach(explode(";\n", trim($sql)) as $query) {
		$ret[$num] = '';
